...
(
    ...
    echo.
    echo === WX-RUNTIME TESTS (chat_panel + message_detail_dialog) ===
    echo.
    uv run pytest tests/ui/test_chat_panel_runtime.py tests/ui/test_message_detail_dialog_runtime.py tests/ui/test_permission_dialog_runtime.py -v --tb=short 2>&1
    echo.
